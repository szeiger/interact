...
class ExecutionMetrics {
  ...
  private[this] var steps, cellAlloc, cellReuse, singletonUse, loopSave, labelCreate = 0
  ...
  def logStats(): Unit = {
    println(s"Steps: ${steps} (${steps-loopSave} non-looping), cells created: ${cellAlloc} new, ${cellReuse} cached, ${singletonUse} singleton, ${labelCreate} new labels created")
  }
  def logMetrics(): Unit = {
